...
BLOG_AUTHOR = "Neel Patel"  # (translatable)
BLOG_TITLE = "Neel Patel"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://neelpatelpdx.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://neelpatelpdx.github.io/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Neel Patel's Personal Webpage"  # (translatable)
...
NAVIGATION_LINKS = {
    # DEFAULT_LANG: (("/posts/index.html", "Blog"),),
    # DEFAULT_LANG: (("/archive.html", "Archive"), ("/categories/", "Tags"), ("/rss.xml", "RSS feed"),),
}
...
#     PAGES = ( ("pages/*.rst", {"en": "pages", "de": "seiten"}, "page.tmpl"), ("pages/*.md", {"en": "pages", "de": "seiten"}, "page.tmpl"),)
...
# BK
# second arg in tuple here is blank
